        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="card p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" class="form-input" placeholder="e.g. Senior Developer" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="location" class="form-input" placeholder="e.g. Jakarta, ID" required>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="start_date" class="form-input" placeholder="e.g. Jan 2022" required>
                        </div>
                        <div>
                            <label class="form-label">End Date</label>
                            <input type="text" name="end_date" class="form-input" placeholder="e.g. Present">
                        </div>
                        <div>
                            <label class="form-label">Duration</label>
                            <input type="text" name="duration" class="form-input" placeholder="e.g. 6 mos">
                        </div>
                    </div>
                        ...
                        <div class="space-y-2">
                            <template x-for="(item, index) in responsibilities" :key="index">
                                <div class="flex gap-2">
                                    <input type="text" name="responsibilities[]" x-model="responsibilities[index]" class="form-input text-xs" placeholder="e.g. Led a team of 5 developers">
                    ...
                    <div class="card p-6">
                        ...
                        <div class="space-y-2">
                            <template x-for="(item, index) in learnings" :key="index">
                                <div class="flex gap-2">
                                    <input type="text" name="learnings[]" x-model="learnings[index]" class="form-input text-xs" placeholder="e.g. Mastered Next.js and Tailwind CSS">
                    ...
                    <div class="card p-6">
                        ...
                        <div class="space-y-2">
                            <template x-for="(item, index) in impact" :key="index">
                                <div class="flex gap-2">
                                    <input type="text" name="impact[]" x-model="impact[index]" class="form-input text-xs" placeholder="e.g. Increased page load speed by 40%">
            ...
            <div class="space-y-6">
                <div class="card p-6 sticky top-24">
                    <h3 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Publishing</h3>
                    <p class="text-[11px] text-gray-500 mb-6">Make sure all mandatory fields marked with (*) are filled before saving.</p>
